...
void
AdvancedSensing::subscribeUpStereoVGA(const uint8_t freq,
                                         VehicleCallBack callback,
                                         UserData userData) {
/*
  if (!vehicle_ptr->isUSBThreadReady())
...
void
AdvancedSensing::subscribeDownStereoVGA(const uint8_t freq,
                                         VehicleCallBack callback,
                                         UserData userData) {
    DSTATUS("M300 VGA freq is running at a default value at 20Hz. So the "
            "parameter freq is useless here.");
...
void
AdvancedSensing::subscribeLeftStereoVGA(const uint8_t freq,
                                         VehicleCallBack callback,
                                         UserData userData) {
    DSTATUS("M300 VGA freq is running at a default value at 20Hz. So the "
            "parameter freq is useless here.");
...
void
AdvancedSensing::subscribeRightStereoVGA(const uint8_t freq,
                                         VehicleCallBack callback,
                                         UserData userData) {
    DSTATUS("M300 VGA freq is running at a default value at 20Hz. So the "
            "parameter freq is useless here.");
...
void
AdvancedSensing::subscribeRearStereoVGA(const uint8_t freq,
                                         VehicleCallBack callback,
                                         UserData userData) {
    DSTATUS("M300 VGA freq is running at a default value at 20Hz. So the "
            "parameter freq is useless here.");
