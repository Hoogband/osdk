...
public:
  ...
  /*! @brief subscribe to VGA (480x640) up stereo images at 10 or 20 fps
   *
   *  @platforms M210V2, M300
   *  @param frequency of images using enum from AdvancedSensingProtocol::FREQ
   *  @param callback callback function
   *  @param userData user data (void ptr)
   */
  void subscribeUpStereoVGA(const uint8_t freq, VehicleCallBack callback = 0, UserData userData = 0);
   ...
   *  @param userData user data (void ptr)
   */
  void subscribeDownStereoVGA(const uint8_t freq, VehicleCallBack callback = 0, UserData userData = 0);
  /*! @brief subscribe to QVGA (240x320) stereo depth map at 10 fps
   *
   *  @platforms M210V2
   *  @param callback callback function
   *  @param userData user data (void ptr)
   */
  void subscribeLeftStereoVGA(const uint8_t freq, VehicleCallBack callback = 0, UserData userData = 0);
  /*! @brief subscribe to QVGA (240x320) stereo depth map at 10 fps
   *
   *  @platforms M210V2
   *  @param callback callback function
   *  @param userData user data (void ptr)
   */
  void subscribeRightStereoVGA(const uint8_t freq, VehicleCallBack callback = 0, UserData userData = 0);
  /*! @brief subscribe to QVGA (240x320) stereo depth map at 10 fps
   *
   *  @platforms M210V2
   *  @param callback callback function
   *  @param userData user data (void ptr)
   */
  void subscribeRearStereoVGA(const uint8_t freq, VehicleCallBack callback = 0, UserData userData = 0);
  /*! @brief subscribe to QVGA (240x320) stereo depth map at 10 fps
   *
   *  @platforms M210V2
   *  @param callback callback function
